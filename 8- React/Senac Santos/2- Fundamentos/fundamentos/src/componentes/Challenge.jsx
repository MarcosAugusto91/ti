const Challenge = () => {
    ...
    //This: Essa é a diferença técnica mais importante, embora em componentes funcionais (como o seu Challenge) ela não faça tanta diferença quanto fazia antigamente em componentes de Classe.
    ...
    return (
        <>
            ...
            <button onClick={() => handleSoma2(20, 30)}> Função com Parâmetros</button>
            <hr />
        </>
    );
}
